 ...
 * @param {Function} props.context.addToCart
 */
const ItemView = (props) => {
  ...
  return (
    <>
      <CartLink />
      <Head>
        <title>Next.js Store - {name}</title>
        <meta name="description" content={`Next.js Store - ${name}`} />
        <meta property="og:title" content={`Next.js Store - ${name}`} key="title" />
      </Head>
      <div className="
        sm:py-12
        md:flex-row
